...
public class Sequence implements Serializable {
	...
	public void setPairSequence(String line1, String line2) {
		if (!SequenceUtils.checkFastaIsWellFormed(line1, line2)
				|| !SequenceUtils.checkIsAValidFastaPair(this.name, this.sequenceString, line1, line2)) {
			throw new InvalidSequenceException();
		}
	...
	public void setPairSequence(String line1, String line2, String line3, String line4) {
		if (!SequenceUtils.checkFastQIsWellFormed(line1, line2, line3, line4) || !SequenceUtils
				.checkIsAValidFastQPair(this.name, this.sequenceString, this.qualityString, line1, line2, line3)) {
			throw new InvalidSequenceException();
		}
